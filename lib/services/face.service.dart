...
class FaceModelService {
  ...
  static final FaceModelService _faceService = FaceModelService._internal();

  factory FaceModelService() {
    return _faceService;
  }
  // singleton boilerplate
  FaceModelService._internal();
  ...
  //     this._interpreter = await Interpreter.fromAsset('model13.tflite',
